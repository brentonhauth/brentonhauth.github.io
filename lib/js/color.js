...
window.LinkedColorElement = class {
    ...
    //------------------------------------------------------------
    Listen(el) {
        this.ElementR.addEventListener("input", () => LinkedColorElement.UpdateColor(el));
        this.ElementG.addEventListener("input", () => LinkedColorElement.UpdateColor(el));
        this.ElementB.addEventListener("input", () => LinkedColorElement.UpdateColor(el));
    }
}
